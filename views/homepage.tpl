...
<section class="portfolio bg-light-gray" style="background-color: #6EC6BA; background-image:url('{{ abtsec.about_section_image.getImage(500, 500, crop) }}');background-size:contain;backgound-position:left bottom;background-repeat:no-repeat;">
	<div class="container">
